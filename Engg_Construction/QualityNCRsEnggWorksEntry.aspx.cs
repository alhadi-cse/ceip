...
public partial class Engg_Engg_Construction_QualityNCRsEnggWorksEntry : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            Session["ReturnUrl"] = "~/Engg_Construction/QualityNCRsEnggWorksEntry.aspx";
            Response.Redirect("~/LoginUser.aspx");
        }
        if (IsPostBack) return;

        //dba.LoadDropDownList("select distinct package_no from base_tbl_polder_info order by package_no", ddlPackageNo,
        //    "package_no", "package_no", "-----select package-----", true);
        dba.LoadDropDownList("select distinct package_no, concat_ws('-', 'Package', package_no) as package_name from base_tbl_polder_info order by package_no",
